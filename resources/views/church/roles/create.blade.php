    ...
    <div class="mx-auto max-w-4xl space-y-6">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">
                Create a custom role and assign the permissions available to your church.
            </p>
        </div>
        ...
        <form
            method="POST"
            action="{{ route('church.roles.store') }}"
            class="space-y-6"
        >
            @csrf
            ...
            <div class="rounded-xl border border-slate-200 bg-white shadow-sm">
                <div class="border-b border-slate-200 px-6 py-4">
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Give the role a clear name that describes its responsibilities.
                    </p>
                </div>
